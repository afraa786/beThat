...
const Navbar = () => {
    ...
    return (
        <nav
            className={`fixed top-0 left-0 w-full z-[9999] flex items-start text-white transition-transform duration-700 ease-out ${isVisible ? "translate-y-0" : "-translate-y-full"
                }`}
        >
            {/* Logo */}
            ...
            <div className="flex items-center gap-[24px] ml-[284px] pt-[40.5px]">
                {["Categories", "Collection", "Our Story", "Contact"].map((item) => (
                    ...
                    >
                        {item}
                        {/* Downward arrow - Simple Chevron Down */}
                        <svg
                            width="10"
                            height="6"
                            viewBox="0 0 10 6"
