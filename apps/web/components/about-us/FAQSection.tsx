    ...
    <section className="w-full bg-[#EFEFEF]">
      ...
      <div className="flex px-[90px] py-[80px] gap-[60px]">
        ...
        <div className="w-1/2">
          ...
          <div className="text-body-lowercase mt-[60px] mb-[40px] flex flex-col">
            <span>she does not follow noise.</span>
            <span>she curates her world carefully.</span>
            <span>she values subtlety over spectacle.</span>
          </div>

          {/* Accordion */}
          <div className="flex flex-col divide-y divide-[#d4d4d4] mt-[80px]">
            {FAQS.map((faq, i) => (
              <div key={i}>
                <button
                  onClick={() => toggle(i)}
        ...
        <div className="w-1/2 flex flex-col items-end">
          ...
          <div className="w-full flex flex-col -mr-[90px]">
            <Image
              src="/gradient-line-faqs.svg"
              alt="gradient line"
              width={0}
              height={0}
              sizes="100vw"
            ...
            />
            <div className="w-full flex flex-col items-end pr-[250px]">
              <Image
                src="/line-below.svg"
                alt="line below"
                width={3}
                height={106}
              />
              <div className="translate-x-[115px] -mt-[38px] relative">
                <div className="absolute -left-[26px] top-[40px] z-0">
                  <CardLarge />
                </div>
