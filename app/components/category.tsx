    ...
    <div style={{ position: "relative", width: 340, height: 460, flexShrink: 0 }}>
      ...
      <div
        style={{
          ...
          width: "16%", height: 56,
          background: "linear-gradient(135deg, #c0bbb4 0%, #a8a39c 100%)",
          clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 28%)",
          zIndex: 2,
        }}
      />
      {/* Right fold flap */}
      <div
        style={{
          ...
          width: "16%", height: 56,
          background: "linear-gradient(225deg, #c0bbb4 0%, #a8a39c 100%)",
...
function SplitImage({
  ...
  return (
    ...
    >
      ...
      {/* TOP label — right side */}
      <div
        style={{
          position: "absolute",
          top: `${bottomHalfTopPercent - 68}%`,
          transform: "translateY(-50%)",
          left: "calc(100% + 24px)",
          opacity: hoveredHalf === "top" ? 1 : 0,
          translate: hoveredHalf === "top" ? "0 0" : "-12px 0",
          transition: `opacity 350ms ${easing}, translate 350ms ${easing}`,
          pointerEvents: "none",
      ...
      {/* BOTTOM label — left side */}
      <div
        style={{
          position: "absolute",
          top: `${bottomHalfTopPercent - 28}%`,
          transform: "translateY(-50%)",
          right: "calc(100% + 24px)",
          opacity: hoveredHalf === "bottom" ? 1 : 0,
          translate: hoveredHalf === "bottom" ? "0 0" : "12px 0",
          transition: `opacity 350ms ${easing}, translate 350ms ${easing}`,
          pointerEvents: "none",
...
export function BrandCarousel() {
  ...
  const sideImages = CAROUSEL_IMAGES
    .map((img, i) => ({ ...img, origIdx: i }))
    ...
    >
        ...
        {SOCIAL.map(({ icon, href, label }) => (
          <a
            ...
            style={{
              ...
              color: "#1a1a1a", textDecoration: "none", flexShrink: 0,
              transition: "transform 200ms ease, background 200ms ease",
            }}
            onMouseEnter={e => {
              (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1.12)";
              (e.currentTarget as HTMLAnchorElement).style.background = "#c8d96a";
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1)";
              (e.currentTarget as HTMLAnchorElement).style.background = "#D9E87C";
            }}
          >
            {icon}
          </a>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, marginLeft: 80, flexShrink: 0 }}>
        {sideImages.slice(0, 2).map(({ src, alt, origIdx }) => (
          <div
            ...
            style={{ ...thumbStyle, width: 130, height: 175 }}
            onMouseEnter={e => {
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24, flexShrink: 0, maxWidth: 340 }}>
        <div style={{ display: "flex", gap: 10 }}>
          {sideImages.slice(2).map(({ src, alt, origIdx }) => (
            <div
              key={origIdx}
              onClick={() => handleClick(origIdx)}
              style={{ ...thumbStyle, width: 120, height: 175 }}
              onMouseEnter={e => {
                (e.currentTarget as HTMLDivElement).style.transform = "scale(1.04)";
                (e.currentTarget as HTMLDivElement).style.boxShadow = "0 6px 20px rgba(0,0,0,0.15)";
              }}
        ...
        <div>
          <h2
            style={{
              color: "#9a9a9a", fontFamily: "Poppins, sans-serif",
          ...
          <p
            style={{
              ...
              color: "#7a7a7a", lineHeight: 1.75, margin: 0, fontStyle: "italic",
            }}
          >
            <strong style={{ fontStyle: "normal", color: "#555" }}>to be that percent</strong>{" "}
            is to choose individuality over uniformity.
            to belong to a smaller circle that values intention,
        ...
        {CAROUSEL_IMAGES.map((_, i) => (
          <button
            ...
            style={{
              ...
              background: i === activeIdx ? "#373737" : "#b0b0b0",
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{
            position: "absolute", top: `${horizontalTop}px`,
        ...
        <style jsx>{`
          ...
          .rack-track:hover { animation-play-state: paused; }
      ...
      >
        ...
        <div style={{ position: "absolute", top: "200px", left: "10%", width: "80%" }}>
          <div style={{ position: "absolute", top: "1000px", left: "-60px", maxWidth: "700px" }}>
            <h1
              style={{
                color: "#373737", fontFamily: "Poppins, sans-serif",
                fontSize: "70px", fontWeight: 700,
            ...
            <p
              style={{
                marginTop: "25px", fontFamily: "Poppins, sans-serif",
        ...
        >
          <SplitImage
            src="/split.png" alt="Feature image"
            splitAxis="horizontal" splitGap={18} duration={900} zoomScale={1.18}
          />
        </div>
        ...
        <div
          style={{
            position: "absolute", top: "600px", left: "14%",
            transform: "translateX(-50%)", width: "108px", height: "108px",
          }}
        >
        ...
        <div
          style={{
            position: "absolute", top: "1000px", right: "-3px",
